 ...
 * )
 */
class EventBlock extends BlockBase implements BlockPluginInterface {
    ...
    public function build(){
        ...
        $endpoint = rtrim($azureuri,'/') . '/Modules/Event?t='. mt_rand() . '&clientid=' . $clientid . '&secret=' . $secret . '&userid=' . $userid;
