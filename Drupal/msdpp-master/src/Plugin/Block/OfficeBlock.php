 ...
 * @Block(
 *   id = "office_block",
 *   admin_label = @Translation("Office Pro-Plus Block"),
 * )
 */
class OfficeBlock extends BlockBase implements BlockPluginInterface {
    ...
    public function build(){
        ...
        $endpoint = rtrim($azureuri,'/') . '/Modules/Office?t='. mt_rand() . '&clientid=' . $clientid . '&secret=' . $secret . '&userid=' . $userid;
