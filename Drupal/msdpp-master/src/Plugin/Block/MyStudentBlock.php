 ...
 * @Block(
 *   id = "mystudent_block",
 *   admin_label = @Translation("My Students Block"),
 * )
 */
class MyStudentBlock extends BlockBase implements BlockPluginInterface {
    ...
    public function build(){
        ...
        $endpoint = rtrim($azureuri,'/') . '/Modules/MyStudents?t='. mt_rand() . '&clientid=' . $clientid . '&secret=' . $secret . '&userid=' . $userid;
